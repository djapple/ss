...
pre_install(){
    ...
    echo "请输入要设置的密码"
    read -p "(默认: djapple):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="djapple"
    echo
    echo "---------------------------"
    echo "已设置密码 = ${shadowsockspwd}"
    echo "---------------------------"
    echo
    ...
    echo -e "请输入要设置的端口"
    read -p "(默认: 12306):" shadowsocksport
    [ -z "${shadowsocksport}" ] && shadowsocksport="12306"
    expr ${shadowsocksport} + 1 &>/dev/null
    if [ $? -eq 0 ]; then
        if [ ${shadowsocksport} -ge 1 ] && [ ${shadowsocksport} -le 65535 ] && [ ${shadowsocksport:0:1} != 0 ]; then
            echo
            echo "---------------------------"
            echo "已设置端口 = ${shadowsocksport}"
            echo "---------------------------"
            echo
            break
        fi
    ...
    echo
    echo "---------------------------"
    echo "已设置加密方式 = ${shadowsockscipher}"
    echo "---------------------------"
    echo
    break
    done
    ...
    read -p "(默认协议: ${protocols[5]}):" protocol
    ...
    echo
    echo "---------------------------"
    echo "已设置加密协议 = ${shadowsockprotocol}"
    echo "---------------------------"
    echo
    break
    done
